...
pub static mut solarBodies: [Body; BODIES_COUNT] = [
    Body {
        // Sun
        position: [0.0; 3],
        velocity: [0.0; 3],
...
pub unsafe fn offset_momentun(bodies: *mut Body) {
...
pub unsafe fn output_energy(bodies: *mut Body) {
    let mut energy = 0.0;
    for i in 0..BODIES_COUNT {
        energy += 0.5
            * (*bodies.add(i)).mass
...
pub unsafe fn advance(bodies: *mut Body) {
